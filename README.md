#  balena-jetson-thor repository

## Linux for Tegra (L4T) Support

This repository contains Jetson AGX Thor Developer Kit T5000 support for balenaOS using L4T 39.2.0.

## Clone/Initialize the repository

* Run "git clone", "git checkout <device integeration branch>"  and then "git submodule update --init --recursive". This will bring in all the needed dependencies.
